<script lang="ts">
  ...
  const entries: PortalEntry[] = [
    ...
    },
    {
      ...
      kicker: "RAI Lab guide",
      description:
        "A practical walkthrough for requesting sponsored HiPerGator access, preparing SSH, and connecting after approval.",
      href: withBase("/hipergator-rai-resources/"),
      action: "Open access guide",
      accent: "green",
      image: pyhazardsImage,
      icon: ServerOutline,
      items: ["Request path", "SSH key", "After approval"],
    },
  ];
...
<main class="portal-page">
  <header class="portal-header">
    <a
      class="brand"
      href={withBase("/")}
      aria-label="Open RAI Hazard Intelligence Hub"
    >
    ...
    <nav class="portal-nav" aria-label="Primary links">
      ...
      <a href={withBase("/hipergator-rai-resources/")}>Access</a>
    </nav>
  </header>
  ...
  <section class="portal-hero" aria-labelledby="portal-title">
    <div class="portal-copy">
      ...
      <p>
        A central portal for research notes, the FireEye map, and PyHazards
        documentation.
      </p>
    </div>
  </section>
    ...
    <div class="footer-bank">
      <div class="contributors-copy">
        <div class="section-heading">
          ...
          <p>
            RAI Lab maintains the research notes, wildfire intelligence tools,
            and documentation linked from this portal.
          </p>
        </div>
...
<style>
  ...
  .entry-media {
    ...
    overflow: hidden;
    background:
      linear-gradient(135deg, rgb(24 35 33 / 8%), rgb(255 255 255 / 40%)),
      #edf3f2;
  }

  .entry-card--red .entry-media {
    background:
      linear-gradient(135deg, rgb(189 59 47 / 16%), rgb(255 255 255 / 46%)),
      #f7eeee;
  }

  .entry-card--blue .entry-media {
    background:
      linear-gradient(135deg, rgb(41 109 152 / 16%), rgb(255 255 255 / 46%)),
      #edf3f7;
  }
  ...
  .entry-card--red .entry-list li {
    background: #faece9;
    border-color: rgb(189 59 47 / 16%);
    color: #8c2b24;
  }

  .entry-card--blue .entry-list li {
    background: #ebf4fa;
  ...
  .contributors-copy {
    display: grid;
    grid-template-rows: minmax(var(--footer-top-bank-height), auto) minmax(
        0,
        1fr
      );
    gap: 12px;
  ...
  @media (max-width: 980px) {
    ...
    .entry-card {
      ...
      grid-template-rows: auto auto minmax(64px, auto) 58px;
    }
