  ...
  const papers: PaperNote[] = [
    {
      ...
      tags: ["Foundation model", "Evaluation contract", "Public release"],
      takeaways: [
    ...
    },
    {
      ...
      tags: ["Benchmark", "Public data", "Discovery-time inputs"],
      takeaways: [
  ...
  <div class="notes-layout">
    <div class="notes-main">
      <section class="notes-intro" aria-labelledby="notes-title">
        ...
        <p>
          Concise summaries of RAI wildfire studies. Each entry highlights the
          problem setting, data sources, evaluation choices, and operational
          implications, with links to the full paper and supporting materials.
        </p>
        <div class="intro-chip-row" aria-label="Research notes overview">
          {#each introChips as chip}
            <span>{chip}</span>
          {/each}
        </div>
      </section>
        ...
        {#each papers as paper}
          <article class={`paper-card paper-card--${paper.theme}`}>
            <div class="paper-media">
              ...
              <div
                class="visual-grid"
                aria-label={`${paper.shortTitle} visual details`}
              >
                <figure class="detail-figure">
                  <img
                    src={paper.detailImage}
                    alt={`${paper.detailLabel} visual`}
                  />
            ...
            <div class="paper-copy">
              <div class="meta-row">
                <span
                  ><CalendarWeekOutline class="meta-icon" /> {paper.date}</span
                >
              ...
              <div
                class="paper-chip-row"
                aria-label={`${paper.shortTitle} metadata`}
              >
                {#each paper.tags as tag}
                  <span class="paper-chip">{tag}</span>
                {/each}
              </div>
              ...
              <div class="paper-actions">
                ...
                <a href={paper.resourceHref} target="_blank" rel="noreferrer">
                  ...
                  {paper.resourceLabel}
                  <ArrowUpRightFromSquareOutline
                    class="action-icon action-icon--small"
                  />
                </a>
              </div>
            </div>
      ...
      <section class="resource-panel" aria-label="Research note archive">
        ...
        <div>
          ...
          <p>
            Each note links back to the full manuscript and the associated
            model, code, or data release when available.
          </p>
        </div>
        <a href={withBase("/")}>
          Back to hub
    ...
    <aside class="notes-rail" aria-label="Research note summary">
      ...
      <div class="hero-note">
        ...
        <div>
          ...
          <strong
            >Two wildfire studies with figures, links, and field-oriented
            takeaways</strong
          >
        </div>
      </div>
      ...
      <div class="hero-strip" aria-label="Research note highlights">
        <article>
          ...
          <div>
            ...
            <p>
              Short summaries connect each study to wildfire modeling and
              decision support.
            </p>
          </div>
        </article>
        ...
        <article>
          ...
          <div>
            <h2>Data Sources</h2>
            <p>
              Figures emphasize weather, fuel, active fire, exposure, and
              evaluation design.
            </p>
          </div>
        </article>
        ...
        <article>
          ...
          <div>
            <h2>Open Access</h2>
            <p>
              Links point to public manuscripts, repositories, and model
...
<style>
  ...
  .paper-card--red .paper-chip {
    background: #faece9;
    border-color: rgb(189 59 47 / 16%);
    color: #8c2b24;
  }

  .paper-card--blue .paper-chip {
    background: #ebf4fa;
    border-color: rgb(41 109 152 / 16%);
    color: #1f638d;
  }
